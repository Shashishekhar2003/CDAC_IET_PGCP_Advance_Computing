...
public class EmployeeDaoImpl implements EmployeeDao {
             ...
             static {
            	 elist=new ArrayList<>();
            	 elist.add(new SalariedEmp(12,"Shashi","4444","Hr","mgr",45678));
            	 elist.add(new ContractEmp(13,"Akshay","55555","admin","asst",45,6666));
            	 elist.add(new SalariedEmp(14,"Yash","4444","Hr","mgr",45678));
            	 elist.add(new ContractEmp(15,"Sandesh","6666","admin","asst",45,6766));
             }
			 @Override
